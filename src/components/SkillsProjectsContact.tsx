...
const SkillsProjectsContact = () => {
  ...
  const skills = {
    "Programming Languages": {
      ...
      items: ["Java", "Python", "JavaScript", "TypeScript", "PHP" , "C", "C++", "SQL"],
      color: "blue"
    },
    "Frontend": {
      icon: <Layout className="w-6 h-6" />,
      items: ["HTML/HTML5", "CSS/CSS3", "Bootstrap", "React", "Material UI", "Angular", "Tailwind CSS", "Redux"],
      color: "purple"
    },
    "Backend": {
      icon: <Server className="w-6 h-6" />,
      items: ["Node.js", "Express.js", "Spring", "Spring Boot", "MVC", "Flask", "FastAPI","Django" ],
      color: "emerald"
    },
    "Databases": {
      icon: <Database className="w-6 h-6" />,
      items: ["MySQL", "PostgreSQL", "MongoDB", "AWS Dynamo DB", "Oracle"],
      color: "cyan"
    },
    "Analytics Tools": {
      icon: <BarChart className="w-6 h-6" />,
      items: ["Apache Spark(PySpark)", "Apache Airflow","TensorFlow","R", "Azure(Databricks, Data Factory, Data lake)","NumPy", "Pandas"],
      color: "amber"
    },
    "Cloud & DevOps": {
      icon: <Cloud className="w-6 h-6" />,
      items: ["Amazon Web Services", "Azure DevOps", "JIRA", "Jenkins", "Docker", "Kubernetes", "Git", "GitHub"],
      color: "orange"
    }
};
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "A blogging platform for university students to share updates, events, and experiences. Built with the MERN stack for seamless authentication and content management.",
      technologies: [
        "MongoDB",
        "Express.js",
        "React",
    ...
    },
    {
      ...
      description: "Developed a comprehensive employee onboarding system that automates HR processes, integrates document management, and optimizes workflows through an intuitive interface.",
      technologies: [
        "Java",
        "Spring Boot",
        "MVC",
